...
#[yutiriti.utility.tree( Any data, Int indent )]: Str
def tree( data:any, indent:int=0 ) -> str:
	...
	#[yutiriti.utility.tree$.builder( Any data, Int indent, Str space )]: Str
	...
	#[yutiriti.utility.tree$.looping( Dict|List[Any]|Set|Tuple data, Int indent, Str space )]: Str
